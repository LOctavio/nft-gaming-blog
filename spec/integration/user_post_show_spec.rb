  ...
  describe 'Post show' do
    before(:each) do
      ...
      user2 = User.new(name: 'Octavio', photo: 'image2',
                       bio: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                       Aenean ullamcorper cursus sollicitudin. Etiam nulla augue,
                       pretium at diam tempus, ornare mollis nunc. Ut enim dolor,
                       fringilla vitae metus id, suscipit.',
      ...
      post = User.all[0].posts.new(title: 'New post 1',
                                   ...
                                   Nunc gravida sit amet elit in euismod. Etiam eu tincidunt augue. Fusce.',
